...
mixin _$DownloadsState {
  ...
  List<ModelDownloads>? get downloads => throw _privateConstructorUsedError;
  Option<Either<MainFailure, List<ModelDownloads>>>
    ...
    return _then(_value.copyWith(
      ...
      downloadFailureOrSuccessOption: null == downloadFailureOrSuccessOption
          ...
          : downloadFailureOrSuccessOption // ignore: cast_nullable_to_non_nullable
              as Option<Either<MainFailure, List<ModelDownloads>>>,
    ) as $Val);
  }
}
...
class _$DownloadsStateImpl implements _DownloadsState {
  const _$DownloadsStateImpl(
      ...
      required final List<ModelDownloads>? downloads,
      required this.downloadFailureOrSuccessOption})
      : _downloads = downloads;

  @override
  final bool isloading;
  final List<ModelDownloads>? _downloads;
  @override
  List<ModelDownloads>? get downloads {
  ...
  @override
  final Option<Either<MainFailure, List<ModelDownloads>>>
      downloadFailureOrSuccessOption;
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      required final List<ModelDownloads>? downloads,
      required final Option<Either<MainFailure, List<ModelDownloads>>>
